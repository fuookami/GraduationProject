...
namespace XSDAnalyzer
{
	...
	private:
		...
		static std::vector<std::vector<int>> generateTopologicalTable(const XMLUtils::XMLNode &root);
		static std::vector<int> topologicalSort(const std::vector<std::vector<int>> &table);
